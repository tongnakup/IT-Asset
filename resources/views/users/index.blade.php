        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div>
                ...
                <div class="flex justify-end mb-4">
                    <button @click="$dispatch('openCreateModal')" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
                        + Add New User
                    </button>
                </div>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @forelse ($users as $user)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $user->employee?->employee_id }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $user->employee?->position }}</td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex items-center justify-start space-x-4">
                                                    <button onclick="Livewire.dispatch('showUserEditModal', { userId: {{ $user->id }} })" class="text-indigo-600 hover:text-indigo-900">Edit</button>
