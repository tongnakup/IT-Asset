<div x-show="sidebarOpen" class="md:hidden fixed inset-0 bg-gray-900 bg-opacity-75 z-20" @click="sidebarOpen = false" x-cloak></div>
            ...
            <div class="mt-6">
                ...
                <div class="mt-2 space-y-1">
                    ...
                    <a href="{{ route('settings.index') }}"
                       class="flex items-center px-4 py-2 mt-2 text-gray-300 rounded-md hover:bg-gray-700 hover:text-white {{ request()->routeIs('settings.index') ? 'bg-gray-900' : '' }}">
                        <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                             stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <a href="{{ route('settings.assign_brands.index') }}"
                       class="flex items-center px-4 py-2 mt-2 text-gray-300 rounded-md hover:bg-gray-700 hover:text-white {{ request()->routeIs('settings.assign_brands.index') ? 'bg-gray-900' : '' }}">
                        <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                           <path stroke-linecap="round" stroke-linejoin="round" d="M9.568 3H5.25A2.25 2.25 0 003 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.33a18.095 18.095 0 005.223-5.223c.542-.827.369-1.908-.33-2.607L11.16 3.66A2.25 2.25 0 009.568 3z" />
                           <path stroke-linecap="round" stroke-linejoin="round" d="M6 6h.008v.008H6V6z" />
                        </svg>
                        <span class="mx-4 font-medium">Assign Brands</span>
                    </a>
                </div>
            </div>
        @endif
